<div class="mb-10 flex flex-wrap items-center gap-3 bg-white/50 backdrop-blur-md p-2 rounded-[2rem] border border-white shadow-sm inline-flex">
    ...
    <a href="{{ route('owner.scan-history') }}" class="flex items-center gap-2 px-6 py-3 rounded-full text-sm font-bold transition-all {{ request()->routeIs('owner.scan-history') ? 'bg-primary-600 text-white shadow-lg shadow-primary-200' : 'text-slate-500 hover:bg-white hover:text-primary-600' }}">
    ...
    @if(auth()->user()->tipe_user !== \App\Models\User::TYPE_EMPLOYEE)
        ...
        <a href="{{ route('owner.employees.index') }}" class="flex items-center gap-2 px-6 py-3 rounded-full text-sm font-bold transition-all {{ request()->routeIs('owner.employees.*') ? 'bg-primary-600 text-white shadow-lg shadow-primary-200' : 'text-slate-500 hover:bg-white hover:text-primary-600' }}">
