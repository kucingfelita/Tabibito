<nav class="mb-8 md:mb-10 mobile-scroll-tabs border-b border-slate-100">
    <a href="{{ route('admin.dashboard') }}"
       class="px-3.5 sm:px-5 py-2.5 sm:py-3 rounded-2xl text-[10px] sm:text-xs font-black uppercase tracking-wider transition-all shrink-0 flex items-center gap-2 whitespace-nowrap
